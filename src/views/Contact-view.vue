...
<template>
  <main class="flex justify-center">
    <section class="shadow-2xl shadow-indigo-500/50 rounded-lg max-w-[68rem]" id="contact">
          ...
          <div class="grid md:grid-cols-2">
            <div class="h-full pr-6">
              <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                ...
                himenaeos. Duis nec ipsum orci. Ut scelerisque sagittis ante, ac tincidunt sem
                venenatis ut.
              </p>
